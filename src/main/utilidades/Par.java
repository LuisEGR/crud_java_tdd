 ...
 *
 * <p>Hacer esto no es una práctica común en java (de hecho, la idea viene importada directo de la
 * biblioteca estándar de C++); sin embargo, para ciertos casos en los que se necesitan regresar
 * dos objetos en lugar de uno, esta clase sirve para agruparlos.
 *
