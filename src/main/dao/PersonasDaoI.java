...
public interface PersonasDaoI {
		 ...
		 *
		 * <p>
		 * Solicitud: crud/06_persona_insertar_persona.pdf
		 *
		 ...
		 *
		 * <p>
		 * Solicitud: crud/07_persona_actualizar_persona.pdf
		 *
		 ...
		 *
		 * <p>
		 * Solicitud: crud/03_persona_obtener_personas.pdf
		 *
		 * @param idMin id mínimo a consultar.
		 * @param idMax id mácimo a consultar.
		 * @return ArrayList de objetos tipo Persona únicamente con los datos id,
		 * nombre y apellidos, dentro del rango especificado (idMin - idMax).
		 */
		 ...
		 *
		 * <p>
		 * Solicitud: crud/04_persona_obtener_persona.pdf
		 *
